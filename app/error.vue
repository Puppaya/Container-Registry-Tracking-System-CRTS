...
const pageTitle = computed(() =>
  props.error.statusCode === 404 ? t('errors.404Title') : t('errors.genericTitle')
)

const pageDescription = computed(() =>
  props.error.statusCode === 404 ? t('errors.404Desc') : t('errors.genericDesc')
)
      ...
      <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 pb-4">
          <h1 class="text-3xl font-bold text-red-600 flex items-center gap-3">
            ...
            {{ t('errors.devError') }}: {{ error.statusCode }}
          </h1>
